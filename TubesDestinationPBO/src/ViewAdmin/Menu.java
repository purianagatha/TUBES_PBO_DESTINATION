...
public class Menu extends javax.swing.JPanel {
    ...
    private void init(){
        listMenu1.addItem(new Model_Menu("Input Destinasi Wisata", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("Destinasi Wisata", Model_Menu.MenuType.MENU));
    ...
    private void initComponents() {
        ...
        listMenu1 = new ViewAdmin.ListMenu<>();
...
//        g2.fillRect(getWidth() - 20, 0, getWidth(), getHeight());
    ...
    private ViewAdmin.ListMenu<String> listMenu1;
